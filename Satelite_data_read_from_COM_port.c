...
{
    if (talker1 == 'G' && talker2 == 'P')
        return "GPS (USA)";
    if (talker1 == 'G' && talker2 == 'L')
        return "GLONASS (Russisch)";
    if (talker1 == 'G' && talker2 == 'A')
        return "Galileo (Europaeisch)";
    if (talker1 == 'G' && talker2 == 'B')
        return "BeiDou (Chinesisch)";
    if (talker1 == 'G' && talker2 == 'Q')
        return "QZSS (Japanisch)";
    return "Unknown";
}
...
void process_line(FILE *output_file)
{
    ...
    while (*p)
    {                                     // Solange der Zeiger nicht am Ende des Strings ('\0') ist
        ...
        if (len >= 32)
            len = 31;                                         // Verhindert Pufferüberlauf
